...
이름: \underline{\hspace{3cm}} \quad 학번: \underline{\hspace{3cm}}
...
많은 행사를 반복했을 때, 장기적으로 신청자의 \underline{\hspace{0.8cm}}%가 참석한다는 뜻이다.

**1-2.** 평균 참석자 수를 계산하라.

$E(X) = np = 20 \times 0.7 = \underline{\hspace{1.5cm}}$명

**1-3.** 세 행사에서 다음 결과가 나왔다. 각 행사의 표본비율을 구하고 모비율과 비교하라.

| 행사 | 실제 참석자 수 $X$ | 표본비율 $X/20$ | $p = 0.7$보다 |
|:---:|:---:|:---:|:---:|
| 가 | 16명 | $\rule{1.5cm}{0.4pt}$ | 크다 / 같다 / 작다 |
| 나 | 12명 | $\rule{1.5cm}{0.4pt}$ | 크다 / 같다 / 작다 |
| 다 | 14명 | $\rule{1.5cm}{0.4pt}$ | 크다 / 같다 / 작다 |
...
부족한 행사: \underline{\hspace{0.8cm}} \quad 충분한 행사: \underline{\hspace{0.8cm}}, \underline{\hspace{0.8cm}}

**2-2.** 준비 인원 14명은 어떤 계산에서 나온 값인가?

$20 \times \underline{\hspace{0.8cm}} = \underline{\hspace{0.8cm}}$명 $\;\rightarrow\;$ 기댓값만큼 준비한 것이다.
...
$20 \times \underline{\hspace{0.8cm}} = \underline{\hspace{0.8cm}}$명
...
|:---:|:---:|:---:|:---:|
| 14명 | 41.6% | 약 $\rule{0.8cm}{0.4pt}$번 | 낮음 |
| 16명 | 10.7% | 약 $\rule{0.8cm}{0.4pt}$번 | 보통 |
| 18명 |  0.8% | 약 $\rule{0.8cm}{0.4pt}$번 | 높음 |

**3-2.** 당신이 담당자라면 몇 명분을 준비하겠는가? 위 표의 수치를 근거로 이유를 쓰라.

준비 인원: \underline{\hspace{0.8cm}}명 \quad 이유:

\vspace{1.5cm}

**3-3.** 준비 부족 확률을 0에 가깝게 낮추려면 어떻게 해야 하는가? 그렇게 하지 않는 이유도 쓰라.

방법: \underline{\hspace{8cm}}

하지 않는 이유: \underline{\hspace{7.2cm}}
...
$E(X) = 100 \times 0.7 = \underline{\hspace{1.5cm}}$명 \quad $c = 100 \times 0.8 = \underline{\hspace{1.5cm}}$명
...
모비율은 \underline{\hspace{4cm}}이지만, 표본비율은 \underline{\hspace{3.5cm}}이므로,

기댓값만큼만 준비하면 \underline{\hspace{8cm}}
