...
(async()=>{
 ...
 assert.equal(await page.locator('#screen-count').textContent(),'2 / 23');
 ...
 console.log('27 views render and allow skipping');
 ...
 await go('N2_operate');await page.locator('#noise-rate').focus();
 ...
 console.log('continuous keyboard slider and saved writing-view resume pass');
 ...
 console.log('layout issues',JSON.stringify(layout));
